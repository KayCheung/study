...
public final class DesensitizeUtils {
    ...
    public static String chineseName(final String fullName) {
        ...
        final String firstName = StringUtils.left(fullName, 1);
    ...
    public static void main(String[] args) {
        System.out.println(fixedPhone("56248271"));
        String address = "长沙市开福区月湖大市场A区28栋";
        System.out.println(address(address, address.length() / 2));
        System.out.println(email("zk@sina.com"));
        System.out.println(bankCard("6222021009200091"));
        System.out.println(cnapsCode("1839909881"));
    }
